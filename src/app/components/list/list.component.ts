import { Component, OnDestroy, OnInit, Testability, ViewChild } from '@angular/core';
...
export class ListComponent implements OnDestroy, OnInit {
	dtOptions: DataTables.Settings = {}; /* Opciones de la datetable */
	dtTrigger = new Subject(); /* Disparador data table */
	data: any; /* Variable para guardar los items de wish list */

  constructor(private _http: HttpClient) { }    

  filterItems =''; /* Filtro de búsqueda */
  wishItems ='';
...
//Remove Wish List	
  remove(i) {   
	...
	if(check.whitelist == "true"){
		...
		var img = document.getElementById("imgWishList" + indice);		
		var img2 = img.setAttribute("src","./assets/images/sinFavorito.png");
	  }else{
		check.whitelist = "true";
		var img = document.getElementById("imgWishlist" + i);
		console.log(img);
		//var img2 = img.setAttribute("src","./assets/images/favorito.png");
	  }
